...
2. Open terminal and download the script by running the following in a terminal:
    ...
    ```bash
    wget https://raw.githubusercontent.com/kronflux/k2-improvements/refs/heads/main/features/cartographer/firmware/flash.sh
    ```
...
4. Open Ubuntu WSL (as Administrator) and download the flash script by entering
    ...
    ```bash
    wget https://raw.githubusercontent.com/kronflux/k2-improvements/refs/heads/main/features/cartographer/firmware/WSLFlash.sh
    ```
